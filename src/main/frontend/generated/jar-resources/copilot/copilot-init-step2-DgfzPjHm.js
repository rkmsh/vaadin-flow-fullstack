import { u as y, v as I, w as V, b as g, j as r, C as q, x as c, y as De, z as S, A as K, B as L, O as de, D as A, F as l, G as Re, H as Be, I as Je, J as Z, K as me, E as u, L as Ve, k as ce, l as Fe, P as qe, N as Xe, V as Ye, Q as Ee, R as C, S as We, T as M, M as _, U as h, W as Ge, X, Y as Ke, Z as ve, _ as ze, $ as Ze, a0 as Qe, a1 as et, a2 as tt, a3 as it, a4 as nt, a5 as ot, a6 as Le, a7 as st, a8 as at, a9 as rt, aa as Me, ab as lt, ac as pe, ad as dt, ae as ct } from "./copilot-Ch3Lmd-_.js";
import { n as R, r as $ } from "./state-CLfnCWiq.js";
import { e as O, m as he } from "./overlay-monkeypatch-DSkmCn3g.js";
import { i as d } from "./icons-O6-0Dxh4.js";
...
c.addPanel(ue);
var It = Object.getOwnPropertyDescriptor, $t = (e, t, i, n) => {
...
var Ct = Object.getOwnPropertyDescriptor, St = (e, t, i, n) => {
...
let Pe = class extends I {
  ...
  getStatus() {
    ...
    if (C.active) {
      const e = Math.round(C.remainingTimeInMillis / 864e5);
      return `Preview expires in ${e}${e === 1 ? " day" : " days"}`;
    }
    if (C.expired && !r.userInfo?.validLicense)
      return "Preview expired";
    if (!C.active && !C.expired && !r.userInfo?.validLicense)
  ...
  renderDot() {
    return r.userInfo?.validLicense ? u : C.active || C.expired ? l`<div class="dot warning"></div>` : u;
  }
};
Pe = St([
...
const $e = window?.Vaadin?.connectionState?.stateChangeListeners;
$e ? $e.add((e, t) => {
...
class W {
  ...
  static debounce(t, i, n) {
    return t instanceof W ? t._cancelAsync() : t = new W(), t.setConfig(i, n), t;
  }
  constructor() {
...
function Vt(e) {
  this._$AN !== void 0 ? (G(this), this._$AM = e, je(this)) : this._$AM = e;
}
function Ft(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) J(n[s], !1), G(n[s]);
  else n != null && (J(n, !1), G(n));
  else J(this, e);
}
const qt = (e) => {
...
class Xt extends at {
  ...
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (J(this, t), G(this));
  }
  setValue(t) {
