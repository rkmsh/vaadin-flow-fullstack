...
var gt = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : li ? function(e) {
...
var Fo = Object.getOwnPropertyDescriptors || function(t) {
  var n = {};
  return gt(t).forEach(function(r) {
    n[r] = Ut(t, r);
  }), n;
};
function D(e, t) {
...
function xe(e, t, n) {
  return _t(e) ? e : Array.isArray(e) ? S.array(e, {
    name: n
    ...
    name: n
  }) : typeof e == "function" && !Fe(e) && !bt(e) ? ai(e) ? He(e) : mt(n, e) : e;
}
function Xo(e, t, n) {
  if (e == null || Ze(e) || fn(e) || ge(e) || J(e))
    return e;
  if (Array.isArray(e))
    return S.array(e, {
      name: n,
...
function Zo(e, t) {
  return process.env.NODE_ENV !== "production" && _t(e) && h("observable.struct should not be used with observable values"), Gi(e, t) ? t : e;
}
var Qo = "override";
function Ft(e) {
...
function ia(e, t, n, r) {
  ...
  if (r === e.target_)
    return this.extend_(e, t, n, !1) === null ? 0 : 2;
  if ((i = this.options_) != null && i.bound && (!H(e.target_, t) || !bt(e.target_[t])) && this.extend_(e, t, n, !1) === null)
    return 0;
  if (bt(n.value))
    return 1;
...
function aa(e, t) {
  ...
  return bt(e) || (e = He(e)), (n = this.options_) != null && n.bound && i(function() {
...
function ha(e, t, n, r) {
  var i, o;
  return pa(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : xe, r);
}
function va(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
  ...
  function a(s, l) {
    var c, u, d = Xe(s)[m], v = new Ae(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : xe, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
function ba(e, t, n, r) {
  ...
  if (r !== e.target_ && typeof n.value == "function") {
    ...
    var u = (s = this.options_) != null && s.autoBind ? mt.bound : mt;
...
function $t(e) {
  return e.deep === !0 ? xe : e.deep === !1 ? an : Pa(e.defaultDecorator);
}
function Ca(e) {
  var t;
...
function bi(e, t, n) {
  ...
  return _t(e) ? e : P(e) ? S.object(e, t, n) : Array.isArray(e) ? S.array(e, t) : Ge(e) ? S.map(e, t) : re(e) ? S.set(e, t) : typeof e == "object" && e !== null ? e : S.box(e, t);
}
ii(bi, mi);
var $a = {
  box: function(t, n) {
    var r = Pt(n);
    return new Ae(t, $t(r), r.name, !0, r.equals);
  },
  array: function(t, n) {
    var r = Pt(n);
  ...
  object: function(t, n, r) {
    return ke(function() {
      return Mi(f.useProxies === !1 || r?.proxy === !1 ? Xe({}, r) : hs({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Q(Sa),
...
}, S = /* @__PURE__ */ ii(bi, $a), _i = "computed", Da = "computed.struct", Tn = /* @__PURE__ */ Yn(_i), Ta = /* @__PURE__ */ Yn(Da, {
...
function Ra(e) {
  Ht !== e.actionId_ && h(30), Ht = e.parentActionId_, e.error_ !== void 0 && (f.suppressReactionErrors = !0), un(e.prevAllowStateChanges_), ft(e.prevAllowStateReads_), L(), e.runAsAction_ && ae(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
...
var Ma = "create", Ae = /* @__PURE__ */ function(e) {
  function t(r, i, o, a, s) {
    var l;
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableValue@" + B() : "ObservableValue"), a === void 0 && (a = !0), s === void 0 && (s = Be.default), l = e.call(this, o) || this, l.enhancer = void 0, l.name_ = void 0, l.equals = void 0, l.hasUnreportedChange_ = !1, l.interceptors_ = void 0, l.changeListeners_ = void 0, l.value_ = void 0, l.dehancer = void 0, l.enhancer = i, l.name_ = o, l.equals = s, l.value_ = i(r, void 0, o), process.env.NODE_ENV !== "production" && a && C() && Ce({
      type: Ma,
      object: l,
...
U.diffValueMask_ = 16;
var dn = /* @__PURE__ */ De("ComputedValue", U), _;
(function(e) {
...
function kn(e) {
  switch (e.dependenciesState_) {
    ...
    case _.POSSIBLY_STALE_: {
      for (var t = Jn(!0), n = Te(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
        var a = r[o];
        if (dn(a)) {
...
function wi(e, t, n) {
  ...
  return f.inBatch--, f.trackingDerivation = i, Ua(e), za(e), ft(r), o;
}
function za(e) {
...
var qt = /* @__PURE__ */ De("Reaction", ee);
function C() {
...
var Xn = "action", Ja = "action.bound", Di = "autoAction", Xa = "autoAction.bound", Ti = "<unnamed action>", Vn = /* @__PURE__ */ xt(Xn), Za = /* @__PURE__ */ xt(Ja, {
  bound: !0
}), Rn = /* @__PURE__ */ xt(Di, {
  autoAction: !0
}), Qa = /* @__PURE__ */ xt(Xa, {
...
function ki(e) {
  var t = function(r, i) {
    if (A(r))
      return Ne(r.name || Ti, r, e);
    if (A(i))
      return Ne(r, i, e);
    if (St(i))
      return (e ? Rn : Vn).decorate_20223_(r, i);
    if (Se(i))
      return At(r, i, e ? Rn : Vn);
    if (Se(r))
      return Q(xt(e ? Di : Xn, {
        name: r,
        autoAction: e
...
var Ee = /* @__PURE__ */ ki(!1);
Object.assign(Ee, Vn);
var mt = /* @__PURE__ */ ki(!0);
Object.assign(mt, Rn);
Ee.bound = /* @__PURE__ */ Q(Za);
mt.bound = /* @__PURE__ */ Q(Qa);
function au(e) {
...
function Zn(e, t, n) {
  ...
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", s = Ee(a, n.onError ? ts(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Vi(n), u = !0, d = !1, v, p = n.compareStructural ? Be.structural : n.equals || Be.default, b = new ee(a, function() {
    u || l ? E() : d || (d = !0, c(E));
...
var _n = /* @__PURE__ */ hi("flow"), ls = /* @__PURE__ */ hi("flow.bound", {
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++ss, u = Ee(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, p = new Promise(function(b, E) {
      var x = 0;
      d = E;
      function G($) {
        v = void 0;
...
var fs = {
  has: function(t, n) {
    return process.env.NODE_ENV !== "production" && f.trackingDerivation && nt("detect new properties using the 'in' operator. Use 'has' from 'mobx' instead."), be(t).has_(n);
  },
  get: function(t, n) {
    return be(t).get_(n);
  },
  set: function(t, n, r) {
    var i;
    return Se(n) ? (process.env.NODE_ENV !== "production" && !be(t).values_.has(n) && nt("add a new observable property through direct assignment. Use 'set' from 'mobx' instead."), (i = be(t).set_(n, r, !0)) != null ? i : !0) : !1;
  },
  deleteProperty: function(t, n) {
    var r;
    return process.env.NODE_ENV !== "production" && nt("delete properties from an observable object. Use 'remove' from 'mobx' instead."), Se(n) ? (r = be(t).delete_(n, !0)) != null ? r : !0 : !1;
  },
  defineProperty: function(t, n, r) {
    var i;
    return process.env.NODE_ENV !== "production" && nt("define property on an observable object. Use 'defineProperty' from 'mobx' instead."), (i = be(t).defineProperty_(n, r)) != null ? i : !0;
  },
  ownKeys: function(t) {
    return process.env.NODE_ENV !== "production" && f.trackingDerivation && nt("iterate keys to detect added / removed properties. Use 'keys' from 'mobx' instead."), be(t).ownKeys_();
  },
...
function hs(e, t) {
  var n, r;
  return oi(), e = Xe(e, t), (r = (n = e[m]).proxy_) != null ? r : n.proxy_ = new Proxy(e, fs);
}
function R(e) {
...
function Je(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!P(e) && !P(Object.getPrototypeOf(e)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), Ze(e) && h("makeAutoObservable can only be used on objects not already made observable")), P(e) ? Mi(e, e, t, n) : (ke(function() {
    var r = Xe(e, n)[m];
    if (!e[yn]) {
      var i = Object.getPrototypeOf(e), o = new Set([].concat(gt(e), gt(i)));
...
function gs(e, t, n, r) {
  return n === void 0 && (n = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), r === void 0 && (r = !1), oi(), ke(function() {
...
var ms = /* @__PURE__ */ De("ObservableArrayAdministration", Qn);
function fn(e) {
  return nn(e) && ms(e[m]);
}
var bs = {}, de = "add", Gt = "delete", Bi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = xe), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[m] = bs, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || h(18), ke(function() {
  ...
  return t.has_ = function(r) {
    ...
    if (!o) {
      var a = o = new Ae(this.has_(r), an, process.env.NODE_ENV !== "production" ? this.name_ + "." + Pn(r) + "?" : "ObservableMap.key?", !1);
    ...
    X(this.keysAtom_), oe(function() {
      var c, u = new Ae(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + Pn(r) : "ObservableMap.key", !1);
    ...
    return oe(function() {
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var $ = i.data_.keys(), ce = a.keys(), me = $.next(), ar = ce.next(); !me.done; ) {
            if (me.value !== ar.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            me = $.next(), ar = ce.next();
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && h("`observe` doesn't support fireImmediately=true in combination with maps."), Ct(this, r);
  }, t.intercept_ = function(r) {
    return Nt(this, r);
  }, Ye(e, [{
    key: "size",
...
}(), ge = /* @__PURE__ */ De("ObservableMap", Bi);
function vr(e) {
...
var ys = {}, Fi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = xe), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[m] = ys, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || h(22), this.enhancer_ = function(a, s) {
      return r(a, s, i);
    }, ke(function() {
  ...
  return t.dehanceValue_ = function(r) {
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && h("`observe` doesn't support fireImmediately=true in combination with sets."), Ct(this, r);
  }, t.intercept_ = function(r) {
    return Nt(this, r);
  }, t.toJSON = function() {
    return Array.from(this);
...
var gr = /* @__PURE__ */ Object.create(null), mr = "remove", jn = /* @__PURE__ */ function() {
  ...
  return t.getObservablePropValue_ = function(r) {
    ...
    return i || (i = new Ae(r in this.target_, an, process.env.NODE_ENV !== "production" ? this.name_ + "." + Pn(r) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(r, i)), i.get();
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof Ae && (u = c.value_), Ni(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), s || l) {
        var v = {
          type: mr,
          observableKind: "object",
          object: this.proxy_ || this.target_,
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && h("`observe` doesn't support the fire immediately property for observable objects."), Ct(this, r);
  }, t.intercept_ = function(r) {
    return Nt(this, r);
...
function Xe(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && Ze(e) && h("Options can't be provided for already observable objects."), H(e, m))
    return process.env.NODE_ENV !== "production" && !(Wi(e) instanceof jn) && h("Cannot convert '" + Yt(e) + `' into observable object:
...
var ws = /* @__PURE__ */ De("ObservableObjectAdministration", jn);
function br(e) {
  return gr[e] || (gr[e] = {
    get: function() {
...
function yr(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Yi(t) && h("Cannot annotate '" + e.name_ + "." + n.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ft(t) && H(e.appliedAnnotations_, n)) {
...
function Ke(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (ge(e)) {
      ...
      return n || h(25, t, Yt(e)), n;
    }
    if (Ze(e)) {
      if (!t)
        return h(26);
      var r = e[m].values_.get(t);
      return r || h(27, t, Yt(e)), r;
    }
    if (Gn(e) || dn(e) || qt(e))
      return e;
  } else if (A(e) && qt(e[m]))
...
function Wi(e, t) {
  if (e || h(29), Gn(e) || dn(e) || qt(e) || ge(e) || J(e))
    return e;
  if (e[m])
    return e[m];
  h(24, e);
...
function Er(e) {
  return fn(e) ? e.slice() : Ge(e) || ge(e) || re(e) || J(e) ? Array.from(e.entries()) : e;
}
...
function ut(e) {
  const t = e.type;
  return t?.$$typeof === Ji && !t.displayName && e.child ? ut(e.child) : Jt(e.type) ?? Jt(e.elementType) ?? "???";
}
function Ks() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((n) => n[Hs()]).find((n) => n), t = Pe(e);
  return Pe(t?.child);
}
function qs(e) {
  const t = [];
...
function Ys(e) {
  return typeof e.type != "function" || Zi(e) ? !1 : !!(Xt(e) || Us(e));
}
function Zi(e) {
  if (!e)
    return !1;
...
const hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ve = "copilot-", Js = "24.7.11", lu = "attention-required", cu = "https://plugins.jetbrains.com/plugin/23758-vaadin", uu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function du(e) {
...
class yl {
  constructor() {
    this.supportsHilla = !0, this.springSecurityEnabled = !1, this.springJpaDataEnabled = !1, this.urlPrefix = "", Je(this);
  }
  setSupportsHilla(t) {
...
class wl {
  constructor() {
    this.palette = { components: [] }, Je(this), this.initializer = new lo(), this.initializer.promise.then(() => {
      Zn(
        () => JSON.stringify(this),
        () => {
...
const Y = (e) => new co(typeof e == "string" ? e : e + "", void 0, rr), Ol = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Sl, defineProperty: xl, getOwnPropertyDescriptor: Nl, getOwnPropertyNames: Cl, getOwnPropertySymbols: Pl, getPrototypeOf: $l } = Object, pn = globalThis, Ir = pn.trustedTypes, Dl = Ir ? Ir.emptyScript : "", Tl = pn.reactiveElementPolyfillSupport, ht = (e, t) => e, Un = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Dl : null;
      break;
...
Me.elementStyles = [], Me.shadowRootOptions = { mode: "open" }, Me[ht("elementProperties")] = /* @__PURE__ */ new Map(), Me[ht("finalized")] = /* @__PURE__ */ new Map(), Tl?.({ ReactiveElement: Me }), (pn.reactiveElementVersions ??= []).push("2.0.4");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = globalThis, en = ir.trustedTypes, jr = en ? en.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, fo = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, ho = "?" + ue, Vl = `<${ho}>`, $e = document, wt = () => $e.createComment(""), Et = (e) => e === null || typeof e != "object" && typeof e != "function", or = Array.isArray, Rl = (e) => or(e) || typeof e?.[Symbol.iterator] == "function", An = `[ 	
\f\r]`, it = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Mr = /-->/g, Lr = />/g, _e = RegExp(`>|${An}(?:([^\\s"'>=/]+)(${An}*=${An}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zr = /'/g, Ur = /"/g, vo = /^(?:script|style|textarea|title)$/i, po = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Ue = po(1), Ou = po(2), ve = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Br = /* @__PURE__ */ new WeakMap(), Oe = $e.createTreeWalker($e, 129);
function go(e, t) {
...
const jl = (e, t) => {
  ...
  let i, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = it;
  for (let s = 0; s < n; s++) {
    const l = e[s];
    let c, u, d = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, u = a.exec(l), u !== null); ) v = a.lastIndex, a === it ? u[1] === "!--" ? a = Mr : u[1] !== void 0 ? a = Lr : u[2] !== void 0 ? (vo.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = _e) : u[3] !== void 0 && (a = _e) : a === _e ? u[0] === ">" ? (a = i ?? it, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? _e : u[3] === '"' ? Ur : zr) : a === Ur || a === zr ? a = _e : a === Mr || a === Lr ? a = it : (a = _e, i = void 0);
    const p = a === _e && e[s + 1].startsWith("/>") ? " " : "";
    o += a === it ? l + Vl : d >= 0 ? (r.push(c), l.slice(0, d) + fo + l.slice(d) + ue + p) : l + ue + (d === -2 ? s : p);
  }
      ...
      if (i.nodeType === 1) {
        ...
        if (vo.test(i.tagName)) {
          ...
          if (v > 0) {
            ...
            for (let p = 0; p < v; p++) i.append(d[p], wt()), Oe.nextNode(), l.push({ type: 2, index: ++o });
            i.append(d[v], wt());
          }
        }
...
class Qe {
  ...
  _$AI(t, n = this) {
    t = We(this, t, n), Et(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== ve && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Rl(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== O && Et(this._$AH) ? this._$AA.nextSibling.data = t : this.T($e.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: n, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Ot.createElement(go(r.h, r.h[0]), this.options)), r);
  ...
  _$AC(t) {
    ...
    return n === void 0 && Br.set(t.strings, n = new Ot(t)), n;
  }
  k(t) {
    or(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let r, i = 0;
    for (const o of t) i === n.length ? n.push(r = new Qe(this.O(wt()), this.O(wt()), this, this.options)) : r = n[i], r._$AI(o), i++;
...
class gn {
  ...
  _$AI(t, n = this, r, i) {
    ...
    let a = !1;
    if (o === void 0) t = We(this, t, n, 0), a = !Et(t) || t !== this._$AH && t !== ve, a && (this._$AH = t);
    else {
      const s = t;
      let l, c;
      for (t = o[0], l = 0; l < o.length - 1; l++) c = We(this, s[r + l], n, l), c === ve && (c = this._$AH[l]), a ||= !Et(c) || c !== this._$AH[l], c === O ? t = O : t !== O && (t += (c ?? "") + o[l + 1]), this._$AH[l] = c;
    }
    a && !i && this.j(t);
  }
  j(t) {
...
class Ul extends gn {
  ...
  _$AI(t, n = this) {
    if ((t = We(this, t, n, 0) ?? O) === ve) return;
...
Hl?.(Ot, Qe), (ir.litHtmlVersions ??= []).push("3.2.1");
const Kl = (e, t, n) => {
  const r = n?.renderBefore ?? t;
  let i = r._$litPart$;
  if (i === void 0) {
    const o = n?.renderBefore ?? null;
    r._$litPart$ = i = new Qe(t.insertBefore(wt(), o), o, void 0, n ?? {});
  }
  return i._$AI(e), i;
};
/**
...
vt._$litElement$ = !0, vt.finalized = !0, globalThis.litElementHydrateSupport?.({ LitElement: vt });
const ql = globalThis.litElementPolyfillSupport;
ql?.({ LitElement: vt });
(globalThis.litElementVersions ??= []).push("4.1.1");
class Wl extends Il(vt) {
}
class Gl extends Wl {
  constructor() {
...
function Yl() {
  we.push(import("./copilot-log-plugin-DIDHyNFa.js")), we.push(import("./copilot-info-plugin-DstvqvcH.js")), we.push(import("./copilot-features-plugin-oCXDAS0X.js")), we.push(import("./copilot-feedback-plugin-C1Cti_-B.js")), we.push(import("./copilot-shortcuts-plugin-BYNqGux_.js"));
}
function Jl() {
  {
...
class Zl {
  constructor() {
    this.active = !1, this.activate = () => {
      this.active = !0, ot()?.focus(), ot()?.addEventListener("focusout", this.keepFocusInCopilot);
    }, this.deactivate = () => {
      this.active = !1, ot()?.removeEventListener("focusout", this.keepFocusInCopilot);
    }, this.focusInEventListener = (t) => {
      this.active && (t.preventDefault(), t.stopPropagation(), qe(t.target) || requestAnimationFrame(() => {
        t.target.blur && t.target.blur(), ot()?.focus();
      }));
    };
  }
  ...
  keepFocusInCopilot(t) {
    t.preventDefault(), t.stopPropagation(), ot()?.focus();
  }
}
...
const at = window.Vaadin.copilot.overlayManager, Nu = {
...
const Ql = bo(Bn), et = window.Vaadin.copilot._machineState;
if (!et)
...
function wo(e) {
  return et.getDismissedNotifications().includes(e);
}
function tc(e) {
  wo(e) || et.addDismissedNotification(e);
}
function nc(e) {
...
function lc() {
  const e = g.userInfo;
  return !e || e.copilotProjectCannotLeaveLocalhost ? !1 : et.isSendErrorReportsAllowed();
}
const cc = (e) => {
  ...
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Ie.ERROR, message: n.map((r) => hc(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function hc(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: _c } = Fl, Pu = (e) => e.strings === void 0, Gr = () => document.createComment(""), st = (e, t, n) => {
  ...
  return n;
}, ye = (e, t, n = e) => (e._$AI(t, n), e), yc = {}, wc = (e, t = yc) => e._$AH = t, Ec = (e) => e._$AH, xn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Yr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    ...
    else if (s[d] === a[b]) l[b] = ye(i[d], o[b]), st(e, l[b + 1], i[d]), d++, b--;
    else if (s[v] === a[p]) l[p] = ye(i[v], o[p]), st(e, i[d], i[v]), v--, p++;
    else if (c === void 0 && (c = Yr(a, p, b), u = Yr(s, d, v)), c.has(s[d])) if (c.has(s[v])) {
      const E = u.get(a[p]), x = E !== void 0 ? i[E] : null;
      if (x === null) {
        const G = st(e, i[d]);
        ye(G, o[p]), l[p] = G;
      } else l[p] = ye(x, o[p]), st(e, i[d], x), i[E] = null;
      p++;
    } else xn(i[v]), v--;
    else xn(i[d]), d++;
    for (; p <= b; ) {
  ...
  return pt`
    ...
    (r) => {
      const i = Po(r.tag);
      return pt` <copilot-section-panel-wrapper panelTag="${i}">
          ${se.shouldRender(r.tag) ? pt`<${i} slot="content"></${i}>` : O}
...
const Cc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Jr = { randomUUID: Cc };
function Do(e, t, n) {
  if (Jr.randomUUID && !e)
...
function Vu() {
  yt("use-dev-workflow-guide"), se.updatePanel(Kc, { floating: !0 });
}
function Io() {
  const e = g.jdkInfo;
...
class Gc {
  ...
  includeReactNode(t) {
    return ut(t) === "PreconfiguredAuthProvider" || ut(t) === "RouterProvider" ? !1 : xr(t) || Ys(t);
  }
  ...
  generateNodeFromFiber(t, n) {
    ...
    return {
      ...
      get uuid() {
        if (lt.has(t))
          return lt.get(t);
        if (t.alternate && lt.has(t.alternate))
          return lt.get(t.alternate);
        const a = Do();
        return lt.set(t, a), a;
      },
      get name() {
  ...
  generateNodeFromFlow(t, n) {
    ...
    return {
      ...
      isReactComponent: !1,
      get name() {
        return Xs(r) ?? Cr(r.element.localName);
      },
      get identifier() {
        return Pr(t);
      },
...
let Cn = !1, ct = 0;
const Hn = (e) => {
  if (et.isActivationShortcut())
    if (e.key === "Shift" && !e.ctrlKey && !e.altKey && !e.metaKey)
      Cn = !0;
    else if (Cn && e.shiftKey && (e.key === "Control" || e.key === "Meta")) {
      if (ct++, ct === 2)
        return g.toggleActive("shortcut"), ct = 0, !0;
      setTimeout(() => {
        ct = 0;
      }, 500);
    } else
...
let ri = class extends Gl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-CEcoaDFT.js"), await import("./copilot-init-step2-DgfzPjHm.js"), il(), Yl(), this.tabIndex = 0, It.hostConnectedCallback(), window.addEventListener("keydown", Hn), this.addEventListener("keydown", ni), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), this.addEventListener("mousemove", this.mouseMoveListener), this.addEventListener("dragover", this.dragOverListener), this.addEventListener("dragleave", this.dragLeaveListener), this.addEventListener("drop", this.dropListener), at.addOverlayOutsideClickEvent();
   ...
   */
  async activate() {
    It.activate(), Zr.copilotActivated(), Xl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), at.onCopilotActivation(), await Yc(), Oo.loadPreviewConfiguration(), this.active = !0, et.isActivationAnimation() && g.activatedFrom !== "restore" && this.getAllDrawers().forEach((e) => {
  ...
  deactivate() {
    ...
    }), this.closeDrawers(), It.deactivate(), Zr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), at.onCopilotDeactivation(), this.active = !1;
  }
  getAllDrawers() {
    return Array.from(this.shadowRoot.querySelectorAll("copilot-drawer-panel"));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), It.hostDisconnectedCallback(), window.removeEventListener("keydown", Hn), this.removeEventListener("keydown", ni), y.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.dragOverListener), this.removeEventListener("dragleave", this.dragLeaveListener), this.removeEventListener("drop", this.dropListener), at.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  renderDrawer(e) {
    return Ue` <copilot-drawer-panel position=${e}> ${Oc(e)} </copilot-drawer-panel>`;
  }
  /**
